...
const engineeringCareers = scienceCareers.filter(c => engineeringIds.includes(c.id));
    ...
    <>
      ...
      <div className="min-h-screen relative overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-6 py-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-8 gradient-text text-center">Engineering Careers</h1>
          <div className="flex flex-col gap-8 w-full max-w-3xl mx-auto">
            {engineeringCareers.map(field => (
              <motion.div
                key={field.id}
