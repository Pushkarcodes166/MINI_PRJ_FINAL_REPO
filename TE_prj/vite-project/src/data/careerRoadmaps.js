    ...
    careers: [
      {
        ...
        description: "Create mechanical designs and prototypes",
        salary: "₹5-18 LPA"
      },
      {
      ...
      },
      {
        ...
        description: "Design vehicles and components",
        salary: "₹6-20 LPA"
      },
      {
        title: "Robotics Engineer",
        description: "Build automated systems",
        salary: "₹8-25 LPA"
      },
      {
        title: "HVAC Engineer",
      ...
      },
      {
        ...
        description: "Work on aircraft and spacecraft",
        salary: "₹10-30 LPA"
      }
    ],
    courses: [
      {
        name: "Advanced CAD with SolidWorks",
        description: "Master 3D modeling and design",
        duration: "3 months",
      ...
      },
      {
        ...
        duration: "2 months",
        platform: "ASQ, Simplilearn"
      }
    ],
    insights: {
      growth: "Mechanical Engineering maintains steady 4% growth with increasing demand in automation, renewable energy, and electric vehicles.",
      salary: "Entry-level: ₹4-8 LPA | Mid-level: ₹10-18 LPA | Senior: ₹20-35 LPA",
      trends: "Electric vehicles, renewable energy systems, 3D printing, robotics, and sustainable manufacturing are key growth areas."
    }
  },
  "Civil Engineering": {
    ...
    careers: [
      ...
      {
        title: "Urban Planner",
        description: "Design city infrastructure",
        salary: "₹6-18 LPA"
      },
      {
        title: "Transportation Engineer",
        description: "Plan roads and transit systems",
        salary: "₹6-22 LPA"
      },
      {
        title: "Environmental Engineer",
        description: "Sustainable infrastructure solutions",
        salary: "₹5-19 LPA"
      },
      {
        title: "Site Engineer",
        description: "Manage on-site construction",
        salary: "₹4-15 LPA"
      }
    ],
    courses: [
      {
        ...
        description: "Earthquake-resistant structures",
        duration: "3 months",
        platform: "NPTEL, Coursera"
      },
      {
        name: "BIM (Building Information Modeling)",
        description: "Revit and 3D construction modeling",
        duration: "2 months",
    ...
    insights: {
      growth: "Civil Engineering shows 6% growth driven by smart cities, infrastructure development, and sustainable construction initiatives.",
      salary: "Entry-level: ₹4-7 LPA | Mid-level: ₹10-20 LPA | Senior: ₹22-40 LPA",
    ...
    careers: [
      {
        ...
        description: "Design electrical grids",
        salary: "₹6-22 LPA"
      },
      {
        title: "Control Systems Engineer",
        description: "Automation and control",
        salary: "₹7-24 LPA"
      },
      {
        title: "Renewable Energy Engineer",
        description: "Solar and wind power systems",
        salary: "₹6-20 LPA"
      },
      {
      ...
      },
      {
        ...
        description: "Project design and advisory",
        salary: "₹8-28 LPA"
      },
      {
    ...
    courses: [
      {
        ...
        description: "Grid design and optimization",
        duration: "3 months",
        platform: "NPTEL, Coursera"
      },
      {
        ...
        duration: "2 months",
        platform: "Udemy, Siemens"
      },
      {
        name: "Renewable Energy Systems",
        description: "Solar and wind power design",
        duration: "4 months",
        platform: "edX, Coursera"
      },
      {
        name: "Electrical CAD with AutoCAD",
        description: "Electrical design software",
        duration: "2 months",
